    ...
    override fun onBindViewHolder(holder: CommentViewHolder, position: Int) {
        ...
        holder.apply {
          //  glide.load(comment.profilePictureUrl).into(ivCommentUserProfilePicture)
            ...
            Glide.with(itemView.context).load(comment.profilePictureUrl).placeholder(R.drawable.man).into(ivCommentUserProfilePicture)

            ibDeleteComment.isVisible = comment.uid == FirebaseAuth.getInstance().currentUser?.uid
