...
class FreeLectureAdapter(options: FirestoreRecyclerOptions<NewLectureDetails>)
    :FirestoreRecyclerAdapter<NewLectureDetails,FreeLectureAdapter.FreeLectureViewHolder>(options)
{
